...
- **2020-04-09:**  
  - ***ktrain*** **v0.13.x is released** and includes support for:
    - **text summarization** with pretrained BART. See [example summarization notebook](https://nbviewer.jupyter.org/github/amaiya/ktrain/blob/master/examples/text/text_summarization_with_bart.ipynb). <sub><sup>(Summarization feature was added in v0.13.1, but not v0.13.0.)</sup></sub>
