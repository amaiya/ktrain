...
- employ fast and easy-to-use pre-canned models for  `text`, `vision`, and `graph` data:
  - `text` data:
     ...
     - **Sequence Labeling**:  [Bidirectional LSTM](https://arxiv.org/abs/1603.01360) with optional CRF layer and pretrained BERT and fasttext word embeddings <sub><sup>[[example notebook](https://nbviewer.jupyter.org/github/amaiya/ktrain/blob/master/tutorials/tutorial-06-sequence-tagging.ipynb)]</sup></sub>
