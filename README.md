...
- **2020-06-03:**  
  - ***ktrain*** **v0.16.x is released** and includes support for **Zero-Shot Learning**, where documents can be classified into user-provided topics **without** any training examples. See the [example notebook](https://github.com/amaiya/ktrain/blob/master/examples/text/zero_shot_learning_with_nli.ipynb).  <sub><sup>(This feature currently requires that PyTorch be installed.)</sup></sub>
```python
...
- employ fast, accurate, and easy-to-use pre-canned models for  `text`, `vision`, and `graph` data:
  - `text` data:
     ...
     - **Zero-Shot Learning**:  classify documents into user-provided topics **without** training examples <sub><sup>[[example notebook](https://github.com/amaiya/ktrain/blob/master/examples/text/zero_shot_learning_with_nli.ipynb)]</sup></sub>
  - `vision` data:
