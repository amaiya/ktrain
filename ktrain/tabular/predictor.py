...
class TabularPredictor(Predictor):
    ...
    def feature_importance(self, test_df, row_index=None, row_num=None, class_id=None, background_size=50, nsamples=500):
        """
	...
	# add synthetic labels
        ...
        if row_index is not None:
            ...
            df_row = df.iloc[row_num:10,:]
            df_display_row = df_display.iloc[row_num:10,:]
            r_key = 'row_num'
            r_val = row_num 
        #print(df_row)
        ...
        print(self.preproc.cat_names + self.preproc.cont_names)
        ...
        plt.show(shap.summary_plot(expected_value, shap_values, df_display_row))
