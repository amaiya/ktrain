    ...
    def fit_generator(
        ...
        if train_data is not None:
            ...
            (
                mapper.NodeSequence,
                mapper.LinkSequence,
                mapper.FullBatchNodeSequence,
                mapper.SparseFullBatchNodeSequence,
            ),
        ):
            raise ValueError(
    ...
    def predict_generator(
        ...
        if predict_data is not None:
            if not isinstance(
                generator,
                (
                    mapper.node_mappers.GraphSAGENodeGenerator,
                    mapper.node_mappers.HinSAGENodeGenerator,
                    mapper.node_mappers.FullBatchNodeGenerator,
                ),
            ):
                raise ValueError(
