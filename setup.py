...
setup(
  ...
  install_requires=[
          ...
          'bokeh',
          'eli5 >= 0.10.0',
          #'sg_ktrain @ https://github.com/amaiya/stellargraph/archive/v0.7.3-pretf.zip'
          'stellargraph@git+ssh://git@github.com/amaiya/stellargraph.git@sg_ktrain_standalone'
          #'pillow'
      ],
