...
- `text`:  
  ...
  - [Zero-Shot Topic Classification](#zsl):  classify documents by user-supplied topics **without** any training examples
- `vision`:  
...
### <a name="zsl"></a>Zero-Shot Topic Classification: [zero_shot_classification_with_nli.ipynb](https://github.com/amaiya/ktrain/tree/master/examples/text)
